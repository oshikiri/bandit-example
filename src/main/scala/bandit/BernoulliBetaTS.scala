...
class BetaBernoulliTS extends SimpleBanditAlgorithm {
  ...
  def updateState(
    state: BetaBernoulliBanditState,
    choosedArmId: ArmId,
    reward: Reward
  ...
  private def updateArms(
    arms: Seq[BetaBernoulliBanditArm],
    choosedArmId: ArmId,
    reward: Reward
  ) = arms.map {
...
object BetaBernoulliTS extends SimpleBanditAlgorithm {
  ...
  case class BetaBernoulliBanditState(arms: Seq[BetaBernoulliBanditArm], nTrials: Long) extends SimpleBanditState

  case class BetaBernoulliBanditArm(
    armId: ArmId,
    nChoosed: Long,
    nSuccess: Long,
    distribution: BetaDistribution
